...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=132)
...
![C:\Users\Administrator\Desktop\img\gaoxiaowuyegongchengbaoxiu\用户.jpg](/md/blog.003.jpeg)
图4.1 用户实体属性图

（2）下图是公告实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaowuyegongchengbaoxiu\公告.jpg](/md/blog.004.jpeg)
图4.2 公告实体属性图

（3）下图是报修实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaowuyegongchengbaoxiu\报修.jpg](/md/blog.003.jpeg)
图4.3 报修实体属性图

（4）下图是工程师实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gaoxiaowuyegongchengbaoxiu\工程师.jpg](/md/blog.003.jpeg)
图4.4 工程师实体属性图
...
|3|gongchengshi\_id|Integer|工程师|是|
|4|baoxiu\_uuid\_number|String|报修编号|是|
|5|baoxiu\_name|String|报修名称|是|
|6|baoxiu\_wupin\_name|String|报修物品|是|
|7|baoxiu\_address|String|报修地点|是|
|8|baoxiu\_types|Integer|报修类型|是|
|9|insert\_time|Date|报修时间|是|
|10|baoxiu\_content|String|报修详情|是|
|11|baoxiu\_zhuangtai\_types|Integer|报修状态|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|gongchengshi\_name|String|工程师姓名|是|
|3|gongchengshi\_phone|String|工程师手机号|是|
|4|gongchengshi\_id\_number|String|工程师身份证号|是|
|5|gongchengshi\_photo|String|工程师头像|是|
|6|gongchengshi\_email|String|电子邮箱|是|
|7|create\_time|Date|创建时间|是|
表4.6管理员表
